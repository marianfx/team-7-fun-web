...
/
  ALTER TABLE Players ADD CONSTRAINT CK_SKILLPOINTS_AVEIABLE CHECK
  (
    SKILLPOINTS>=0
  )
  ENABLE;
...
/
  ...
  ENABLE;
  ALTER TABLE Items ADD CONSTRAINT CK_SKILL_POSITIVITY CHECK
  (
    SKILL IN ('S_LUCKY','S_TIME', 'S_CHEAT') 
  )
  ENABLE;
...
/
  ALTER TABLE BattlesHistory ADD CONSTRAINT CK_WINNER_VALIDE CHECK
  (
    WINNER IN (0,1,2)
  )
  ENABLE;